...
// -1000 <= Node.val <= 1000 
// 
// Related Topics Dynamic Programming Tree Depth-First Search Binary Tree 👍 770
//8 👎 469
...
class Solution {
    ...
    private int maxPathSumCore(TreeNode root){
        ...
        int leftSum = Math.max(0, maxPathSumCore(root.left));
        int rightSum = Math.max(0, maxPathSumCore(root.right));
