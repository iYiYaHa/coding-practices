...
public:
    TreeNode *lowestCommonAncestor(TreeNode *root, TreeNode *p, TreeNode *q)
    {
        if (root == nullptr || p == nullptr || q == nullptr)
            return nullptr;
        list<TreeNode *> pathP = findPathFromRoot(root, p);
        list<TreeNode *> pathQ = findPathFromRoot(root, q);
...
{
public:
    // return value !=nullptr represents that at least one of p and q is in root.
    TreeNode *lowestCommonAncestor(TreeNode *root, TreeNode *p, TreeNode *q)
    {
