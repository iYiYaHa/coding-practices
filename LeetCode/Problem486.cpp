...
////  that number will not be available for the next player. This continues until 
...
//
//int main() {
//	std::vector<std::vector<int>> testCase = { {1, 5, 233, 7},{1, 5, 2} };
//	std::vector<bool> testAns = { true,false };
//	for (int i = 0; i < testCase.size(); ++i) {
//		bool result = Solution().PredictTheWinner(testCase[i]) == testAns[i];
//		if (result)
